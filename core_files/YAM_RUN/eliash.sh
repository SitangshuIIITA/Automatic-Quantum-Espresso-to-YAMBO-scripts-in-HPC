	...
	cd $PATH1
		...
		#---------------------------------------------Spectral function calculation: Indirect gap---------------------------------------------------------#
			...
			#---------------------------------------------Spectral function calculation: direct gap-----------------------------------------------------------#
					...
					sed -i 's/PhBroad= 0.010000/PhBroad= 0.0050000/g'			eliash.${line}$Kelvin.ind.in
					...
					paste o-qp-${line}$Kelvin.g_sq_F_b_$ind_v\_k\_$start_k o-qp-${line}$Kelvin.g_sq_F_b_$ind_c\_k\_$end_k | awk '{print $1,$10-$2}' > $prefix.${line}$Kelvin.eliash_diff_indirect.txt
					...
					ypp_ph -s e -F eliash.${line}$Kelvin.dir.in
                                        ...
                                        sed -i 's/PhBroad= 0.010000/PhBroad= 0.0050000/g'                       eliash.${line}$Kelvin.dir.in
					...
					awk '/Direct Gap localized at k/ {print $8}' r_setup > 1
                                        ...
                                        paste o-qp-${line}$Kelvin.g_sq_F_b_$ind_v\_k\_$start_k o-qp-${line}$Kelvin.g_sq_F_b_$ind_c\_k\_$end_k | awk '{print $1,$10-$2}' > $prefix.${line}$Kelvin.eliash_diff_direct.txt
